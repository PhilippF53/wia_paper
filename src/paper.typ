...
Für die Validierung des Trainings wird der e-ophta-Datensatz #cite(<teleophta>, supplement: "S. 197-8") verwendet, welcher aus zwei Datenbanken besteht. Die vorliegende Untersuchung umfasst 47 Fundusfotografien, die mit Exsudationen assoziiert sind, sowie 35 Fundusfotografien, die als gesund einzustufen sind. Die andere mit 148 weist Mikroaneurysmen auf und ist mit 233 gesunden Bildern ergänzt. Die vorliegenden Daten wurden bereits pixelgenau von Ophthalmologen annotiert und segmentiert.
...
Die Expertenintervierws gelten dem Erfassen und Bewerten der Benutzbarkeit und Akzeptanz von Computer-Vision-Modellen durch Ärzte im klinischen Alltag. Dafür wird die Spezifikation nach #cite(<experteninterviews>, form: "author")#cite(<experteninterviews>, supplement: "S. 887-889") befolgt.

=== Usability

Die grundlegende Voraussetzung für den erfolgreichen Einsatz neuer Dialogsysteme im klinischen Umfeld ist eine adäquate Benutzbarkeit. Das System sollte dabei den Prinzipien der ISO 9241-10 entsprechen. Diese lassen sich wie von #cite(<usability>, form: "author")#cite(<usability>, supplement: "S. 2") beschrieben zusammenfassen:
...
Ein weiterer wesentlicher Aspekt, der in der vorliegenden Untersuchung berücksichtigt werden muss, ist die Akzeptanz eines solchen Systems unter den Endnutzern. Gemäß #cite(<akzeptanz>, form: "author")#cite(<akzeptanz>, supplement: "S. 667, 678") ist eine effiziente Nutzung dieses nur unter der Prämisse möglich, dass diese auch von den Anwendern akzeptiert wird. Im Rahmen der vorliegenden Experteninterviews wird der Fokus darauf gelegt, die Möglichkeiten zur Erreichung einer solchen Akzeptanz bei den Ärzten zu erörtern und entsprechende Sicherungsmaßnahmen zu erarbeiten.

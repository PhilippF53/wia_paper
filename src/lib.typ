#let ieee(
  ...
  set std.bibliography(title: text(10pt)[Referenzen], style: "ieee")
  ...
  set par(spacing: 0.45em, justify: true, first-line-indent: (amount: 1em, all: true), leading: 0.45em)
